    ...
    public class SuggestComboBox : ComboBox
    {
        ...
        protected override void OnTextChanged(EventArgs e)
       {
            ...
            try
            {
                ...
                _suggBindingList.Remove("Select Member");
                _suggBindingList.RaiseListChangedEvents = true;
                _suggBindingList.ResetBindings();

                _suggLb.Visible = _suggBindingList.Any();

                if (_suggBindingList.Count == 1 && _suggBindingList.Single().Length == Text.Trim().Length)
                {
        ...
        private void OnParentChanged(object sender, EventArgs e)
        {
            ...
            _suggLb.Font = new System.Drawing.Font("Segoe UI", 9);
        }
