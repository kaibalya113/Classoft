...
namespace ClassManager.WinApp
{
    public partial class FrmEnquiryEntryForm : FrmParentForm
    {
        ...
        public FrmEnquiryEntryForm()
        {
            ...
            traslatableMaterialTextfiels.Add(txtParentContact);
        }
        ...
        private void loadEnquiryReferences()
        {
            try
            {
                ...
                if(enquiryReferences != null && enquiryReferences.Length > 0)
                {
                    ...
                    cmbRefBy.Items.AddRange(sources);
                }
            }
            catch (Exception)
            {
        ...
        private bool validate()
        {
            ...
            try
            {
                ...
                else if (txtParentContact.Text.Length == 0 || txtParentContact.Text.Trim() == "")
                {
                    UICommon.WinForm.showStatus("Please enter decision maker contact.", MessageBoxButtons.OK, MessageBoxIcon.Information, sCaption, this);
                    txtFName.Focus();
                    return false;
                }
        ...
        private void bgwekerSendSMS_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            if (e.Error != null)
            {
                Common.Log.LogError(Log.Level.ERROR, e.Error.ToString() + e.Error.StackTrace);
        ...
        private void btnViewAll_Click_1(object sender, EventArgs e)
        {
            try
            {
                FrmEnquiryReport frmEnquiries = UICommon.FormFactory.GetForm(UICommon.Forms.FrmEnquiryReport) as FrmEnquiryReport;
            ...
            try
            {
                if (validate())
                {
                    if (btnSave.Text.ToString().Trim() == "SAVE")
                    {
                        ...
                        objEnquiry.motherContact = txtMotherCotact.Text;
                        ...
                        objFollowup.FollowupBy = cmbField.Text;
                    ...
                    else
                    {
                        ...
                        objEnqUpdate.motherContact = txtMotherCotact.Text;
        ...
        private void txtMotherCotact_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (txtMotherCotact.Text.Length >= 10)
            {
                if (e.KeyChar != (char)8)
                {
                    e.Handled = true;
        ...
        public void setValuesForUpdate(string EnquiryID)
        {
            try
            {
                ...
                txtMotherCotact.Text = record.Tables[0].Rows[0].ItemArray[17].ToString();
                ...
                cmbField.SelectedItem = record.Tables[0].Rows[0].ItemArray[17].ToString();
                ...
                txtDescription.Text = (record.Tables[4].Rows.Count > 0) ? record.Tables[4].Rows[0].ItemArray[4].ToString() : "";
